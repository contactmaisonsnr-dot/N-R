      ...
      <section className="px-6 pb-12 pt-12">
        <RevealOnScroll className="mx-auto max-w-6xl text-center">
          <h1 className="font-heading text-4xl md:text-5xl font-semibold text-clay">
            Nos <span className="italic text-terracotta">projets</span>
          </h1>
              ...
              <button
                ...
                className={`rounded-full px-5 py-2 font-heading text-sm font-semibold transition-colors duration-200 cursor-pointer ${
                  activeCategory === category
                    ...
                    : 'glass text-clay hover:bg-white/70'
                }`}
              ...
              >
                <article>
                  <div className="relative">
                    ...
                    />
                    <div className="absolute inset-0 flex items-end rounded-2xl bg-clay/0 p-5 opacity-0 transition-opacity duration-300 group-hover:bg-clay/30 group-hover:opacity-100">
